      seqfile = full.paml      * sequence data filename
     treefile = marked_tree_paml2.txt      * tree structure file name
      outfile = Ma0           * main result file name
    ...
    CodonFreq = 2  * 0:1/61 each, 1:F1X4, 2:F3X4, 3:codon table
        ...
        ndata = 13 * number of gene alignments to be analysed
